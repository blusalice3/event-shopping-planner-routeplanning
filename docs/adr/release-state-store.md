...
- Status: Accepted for implementation; production binding blocked
- Date: 2026-08-06
...
- distinct role/reviewer を持つ protected approval
...
- approval ID と provider reviewer ID は全て distinct
...
- acceptance は minimum observation end と三役 approval より前に行わない
