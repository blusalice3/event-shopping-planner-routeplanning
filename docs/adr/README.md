...
| ADR                                             | 状態                                                                        | 決定                                                                                                  |
| ----------------------------------------------- | --------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------- |
| [Release State store](release-state-store.md)   | Accepted for implementation; amended 2026-08-10; production binding blocked | PostgreSQL append-only store、CAS、single-account human operation、role-complete approvals、reconcile |
