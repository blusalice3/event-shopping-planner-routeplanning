...
export function FocusModeFooterPortal({
  ...
  return ReactDOM.createPortal(
    ...
    >
      <div
        className={
          compact ? "px-4 py-2" : "max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-3"
        }
      >
        <div
          className={
            compact
              ...
              : "flex flex-col sm:flex-row justify-between items-center text-center sm:text-left gap-2"
          }
        >
          <div className="text-slate-700 dark:text-slate-300">
            <span
              className={
                compact
                  ? "font-bold text-lg text-indigo-600 dark:text-indigo-400"
          ...
          >
            <SpaceNavigatorFooterButton compact={compact} />
            <div
              className={
                compact
              ...
              <span
                className={
                  compact
                    ...
                    : "font-bold text-xl text-blue-600 dark:text-blue-400"
                }
              >
