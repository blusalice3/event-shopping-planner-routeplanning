...
const representativeShoppingItemCardProps = {
  ...
  onPostEventDistributionCheckRequest: vi.fn(),
...
describe("item snapshot comparator", () => {
  ...
  it.each(SHOPPING_ITEM_SNAPSHOT_KEYS)(
    "detects item snapshot changes for %s",
    (key) => {
