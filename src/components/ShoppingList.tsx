...
const ShoppingList: React.FC<ShoppingListProps> = ({
  ...
  const handleExecuteBulkStatusChange = useCallback(
    ...
    [isInspecting, onBulkStatusChange, openPostEventDistributionCheck, startLimitedBulkFlow],
  );
  ...
  if (showSpaceGroups && spaceGroups.length > 0) {
    ...
    return (
      ...
      >
          ...
          return (
            ...
            <div className="mb-1 relative">
              ...
              <div
                ...
                style={{ borderLeft: '4px solid #9CA3AF' }}
                 ...
                 data-space-navigation-visit-id={
                   group.items[0] ? getExecutionVisitIdForItem(group.items[0]) : undefined
                 }
              ...
              >
                ...
                {!isInspecting &&
                  !(viewMode !== 'execute' && layoutMode === 'smartphone' && group.isCollapsed) &&
                  onAddItem && (
                  <button
                    onClick={(e) => {
                      e.stopPropagation();
                  ...
                  {group.items.map((item, spaceItemIndex) => {
                    ...
                    return (
                      <div
                       ...
                       onDragStart={!isInspecting ? (e) => handleDragStart(e, item) : undefined}
        ...
        {addDialogOpen && !isInspecting && ReactDOM.createPortal(
          <div
      ...
      {items.map((item, index) => {
        ...
        return (
           <div
             ...
             onDrop={!isInspecting ? handleDrop : undefined}
             onDragEnd={!isInspecting ? cleanUp : undefined}
             onTouchStart={!isInspecting ? (e) => handleItemTouchStart(e, item) : undefined}
             onTouchMove={!isInspecting ? handleItemTouchMove : undefined}
             onTouchEnd={!isInspecting ? handleItemTouchEnd : undefined}
             onTouchCancel={!isInspecting ? handleItemTouchCancel : undefined}
            className="transition-opacity duration-200 relative"
