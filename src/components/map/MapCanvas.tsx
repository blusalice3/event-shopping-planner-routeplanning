...
const MapCanvas: React.FC<MapCanvasProps> = ({
  ...
  const cellStates = useMemo(() => {
    ...
    items.forEach((item) => {
      ...
      const myJersey = sharing?.members.find((m) => m.userId === sharing.userId)?.jerseyNumber;
      if (sharing?.activeRoom && item.assignedTo && item.assignedTo !== (myJersey != null ? String(myJersey) : null)) {
