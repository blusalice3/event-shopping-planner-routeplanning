...
type AppMainContentProps = {
  ...
  handleAddToExecuteListFromMapAtPosition: NonNullable<MapViewProps['onAddToExecuteListAtPosition']>;
  handleBatchAddToExecuteListFromMap: NonNullable<MapViewProps['onBatchAddToExecuteList']>;
  handleBatchAddToExecuteListFromMapAtPosition: NonNullable<MapViewProps['onBatchAddToExecuteListAtPosition']>;
  handleBatchRemoveFromExecuteListFromMap: NonNullable<MapViewProps['onBatchRemoveFromExecuteList']>;
  handleBulkAdd: (
    eventName: string,
  ...
  handleCollapseAndOpenNext: NonNullable<ShoppingListProps['onCollapseAndOpenNext']>;
  ...
  handleExecuteSpaceGroupOrderChange: NonNullable<ShoppingListProps['onSpaceGroupOrderChange']>;
  handleExecuteToggleAllSpaceCollapse: NonNullable<ShoppingListProps['onToggleAllSpaceCollapse']>;
  handleExecuteToggleSpaceCollapse: NonNullable<ShoppingListProps['onToggleSpaceCollapse']>;
  ...
  handleRemoveFromExecuteColumn: NonNullable<ShoppingListProps['onRemoveFromColumn']>;
  ...
  handleReorderExecuteListByHallOrder: NonNullable<MapViewProps['onReorderExecuteList']>;
  handleSelectEvent: EventListScreenProps['onSelect'];
  handleSelectItem: ShoppingListProps['onSelectItem'];
  handleSelectSpaceGroupForRange: NonNullable<ShoppingListProps['onSelectSpaceGroupForRange']>;
  handleSetSpaceGroupDragItemIds: NonNullable<ShoppingListProps['onSetSpaceGroupDragItemIds']>;
  handleToggleAllSpaceCollapse: NonNullable<ShoppingListProps['onToggleAllSpaceCollapse']>;
  handleToggleBlockFilter: (block: string) => void;
  handleToggleRangeSelection: NonNullable<ShoppingListProps['onToggleRangeSelection']>;
  handleToggleSpaceCollapse: NonNullable<ShoppingListProps['onToggleSpaceCollapse']>;
